...
""" 
This Python script defines two functions: `parse_log_file` and `nmea_to_csv`. 
The `parse_log_file` function takes an input file path, reads a log file, extracts data,
and writes it to CSV files.
 The `nmea_to_csv` function converts NMEA data to a CSV format.
"""
...
if __name__ == '__main__':
    input_filepath ='C:/Users/shira/PycharmProjects/ex_0_robots/Data/gnss_log_2024_04_13_19_51_17.txt'
